...
public interface WrmdataApi {
    ...
    @ApiOperation(value = "WRM Data to be retrieved", notes = "Obtain the history of WRM data for a given groupid, userid and chemical id for a given period of time and granularity ", response = WRMDataListResponse.class, tags={ "WRMData", })
    @ApiResponses(value = { 
...
,@ApiParam(value = "") @RequestParam(value = "timeperiod", required = false) String timeperiod
    ...
    @ApiOperation(value = "Add a wrm data type", notes = "This endpint adds a new wrm data type to the system. It accepts a json which would include wrm data type name, description and would return a unique identifier of the wrm data type upon success ", response = WRMDataPostResponse.class, tags={ "WRMData", })
    @ApiResponses(value = { 
