...
public interface WatertypesApi {
	...
	ResponseEntity<WaterTypeListResponse> watertypesGet(
	...
	@ApiOperation(value = "Add a water type", notes = "This endpint adds a new water type to the system. It accepts a json which would include water type name, description and would return a unique identifier of the water type upon success ", response = WaterPostResponse.class, tags = {
			"WaterTypes", })
	@ApiResponses(value = {
	...
	@RequestMapping(value = "/watertypes", produces = { "application/json" }, consumes = {
	...
	@ApiOperation(value = "Add a water bay accociation", notes = "This endpint adds a new water bay association to the system. It accepts a json which would include water type name, description and would return a unique identifier of the water type upon success ", response = WaterPostResponse.class, tags = {
			"WaterTypes", })
	@ApiResponses(value = {
			@ApiResponse(code = 201, message = "upon successful creation of a water type", response = WaterPostResponse.class),
			@ApiResponse(code = 200, message = "upon error", response = WaterPostResponse.class) })
	@RequestMapping(value = "/watertypes/bays", produces = { "application/json" }, consumes = {
			"application/json" }, method = RequestMethod.POST)
	ResponseEntity<WaterPostResponse> waterbayassociationPost(
	...
	@ApiOperation(value = "Add a water element accociation", notes = "This endpint adds a new water bay association to the system. It accepts a json which would include water type name, description and would return a unique identifier of the water type upon success ", response = WaterPostResponse.class, tags = {
			"WaterTypes", })
	@ApiResponses(value = {
			@ApiResponse(code = 201, message = "upon successful creation of a water type", response = WaterPostResponse.class),
			@ApiResponse(code = 200, message = "upon error", response = WaterPostResponse.class) })
	@RequestMapping(value = "/watertypes/elements", produces = { "application/json" }, consumes = {
			"application/json" }, method = RequestMethod.POST)
	ResponseEntity<WaterPostResponse> waterelementassociationPost(
